...
export default function Dashboard(){
  return <div className='h-screen bg-blue-50 flex flex-col'>
    <Control />
    <main className='p-6 grid gap-2 flex-1' style={{gridTemplateColumns:'2fr 1fr',gridTemplateRows:'minmax(300px,44vh) minmax(300px,44vh)'}}>
...
const CardChart=({children,title}:{children:React.ReactNode,title?:string})=>{
  return <div className="w-full bg-white p-4 rounded-md">
